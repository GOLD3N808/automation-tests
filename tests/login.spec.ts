...
test('Login with empty username and empty password filds', async ({ loginPage, page}) => {
...
test('Login using incorrect username and incorrect password', async ({ loginPage, page }) => {
